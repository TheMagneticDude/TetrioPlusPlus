...
void TetrisBoard::drawBorder() {    
    ...
    // bottom boarder
    LCD.FillRectangle(pos_x - borderScale, pos_y + SCALE * (grid.height-1), SCALE * (grid.width) + 2 * borderScale, borderScale);
    ...
    LCD.FillRectangle(pos_x - borderScale + SCALE * grid.width + borderScale, pos_y - borderScale*2, borderScale, SCALE * (grid.height) + borderScale);
}
